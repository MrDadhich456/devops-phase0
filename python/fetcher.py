...
def fetch_posts(user_id):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Keep only the posts where the 'userId' matches the user_id passed to the function
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Fetch JSON posts for a specific user.")
    
    # Add the argument. Make sure the type is int!
    parser.add_argument('--user-id', type=int, required=True, help="The ID of the user to fetch posts for")
